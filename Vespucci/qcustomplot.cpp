/***************************************************************
 * Vespucci-QCP, a very very minor modification to QCustomPlot *
 * Modifications as noted in text (C) 2014 Daniel Foose        *
 * QCP IP notice repeated verbatim below                       *
 * *************************************************************/
/***************************************************************************
**                                                                        **
...
void QCPColorGradient::loadPreset(GradientPreset preset)
{
  ...
  case vSpectral:
      ...
      setColorStopAt(1.0/64.0, QColor(0,0,36));
      setColorStopAt(2.0/64.0, QColor(0,0,73));
      setColorStopAt(3.0/64.0, QColor(0,0,109));
      setColorStopAt(4.0/64.0, QColor(0,0,146));
      setColorStopAt(5.0/64.0, QColor(0,0,182));
      setColorStopAt(6.0/64.0, QColor(0,0,219));
      setColorStopAt(7.0/64.0, QColor(0,0,255));
      setColorStopAt(8.0/64.0, QColor(0,16,255));
      setColorStopAt(9.0/64.0, QColor(0,32,255));
      setColorStopAt(10.0/64.0, QColor(0,48,255));
      setColorStopAt(11.0/64.0, QColor(0,64,255));
      setColorStopAt(12.0/64.0, QColor(0,80,255));
      setColorStopAt(13.0/64.0, QColor(0,96,255));
      setColorStopAt(14.0/64.0, QColor(0,111,255));
      setColorStopAt(15.0/64.0, QColor(0,128,255));
      setColorStopAt(16.0/64.0, QColor(0,143,255));
      setColorStopAt(17.0/64.0, QColor(0,159,255));
      setColorStopAt(18.0/64.0, QColor(0,175,255));
      setColorStopAt(19.0/64.0, QColor(0,191,255));
      setColorStopAt(20.0/64.0, QColor(0,207,255));
      setColorStopAt(21.0/64.0, QColor(0,223,255));
      setColorStopAt(22.0/64.0, QColor(0,239,255));
      setColorStopAt(23.0/64.0, QColor(0,255,255));
      setColorStopAt(24.0/64.0, QColor(16,255,239));
      setColorStopAt(25.0/64.0, QColor(32,255,223));
      setColorStopAt(26.0/64.0, QColor(48,255,207));
      setColorStopAt(27.0/64.0, QColor(64,255,191));
      setColorStopAt(28.0/64.0, QColor(80,255,175));
      setColorStopAt(29.0/64.0, QColor(96,255,159));
      setColorStopAt(30.0/64.0, QColor(111,255,143));
      setColorStopAt(31.0/64.0, QColor(128,255,128));
      setColorStopAt(32.0/64.0, QColor(143,255,111));
      setColorStopAt(33.0/64.0, QColor(159,255,96));
      setColorStopAt(34.0/64.0, QColor(175,255,80));
      setColorStopAt(35.0/64.0, QColor(191,255,64));
      setColorStopAt(36.0/64.0, QColor(207,255,48));
      setColorStopAt(37.0/64.0, QColor(223,255,32));
      setColorStopAt(38.0/64.0, QColor(239,255,16));
      setColorStopAt(39.0/64.0, QColor(255,255,0));
      setColorStopAt(40.0/64.0, QColor(255,239,0));
      setColorStopAt(41.0/64.0, QColor(255,223,0));
      setColorStopAt(42.0/64.0, QColor(255,207,0));
      setColorStopAt(43.0/64.0, QColor(255,191,0));
      setColorStopAt(44.0/64.0, QColor(255,175,0));
      setColorStopAt(45.0/64.0, QColor(255,159,0));
      setColorStopAt(46.0/64.0, QColor(255,143,0));
      setColorStopAt(47.0/64.0, QColor(255,128,0));
      setColorStopAt(48.0/64.0, QColor(255,111,0));
      setColorStopAt(49.0/64.0, QColor(255,96,0));
      setColorStopAt(50.0/64.0, QColor(255,80,0));
      setColorStopAt(51.0/64.0, QColor(255,64,0));
      setColorStopAt(52.0/64.0, QColor(255,48,0));
      setColorStopAt(53.0/64.0, QColor(255,32,0));
      setColorStopAt(54.0/64.0, QColor(255,16,0));
      setColorStopAt(55.0/64.0, QColor(255,0,0));
      setColorStopAt(56.0/64.0, QColor(255,32,32));
      setColorStopAt(57.0/64.0, QColor(255,32,32));
      setColorStopAt(58.0/64.0, QColor(255,64,64));
      setColorStopAt(59.0/64.0, QColor(255,96,96));
      setColorStopAt(60.0/64.0, QColor(255,128,128));
      setColorStopAt(61.0/64.0, QColor(255,159,159));
      setColorStopAt(62.0/64.0, QColor(255,191,191));
